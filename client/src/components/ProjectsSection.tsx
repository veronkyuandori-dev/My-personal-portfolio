...
const projects = [
  {
    ...
    requirements: {
      ...
      'README.md': ['Project description', 'Features & capabilities', 'Setup instructions', 'Database schema'],
      'Configuration Files': ['requirements.txt (Python dependencies)', '.env.example'],
      '.gitignore': ['__pycache__', '.env', '.venv', 'database files'],
      'Documentation': ['API endpoints', 'Database configuration'],
  ...
  },
  {
    ...
    requirements: {
      ...
      'README.md': ['Features & functionality', 'Setup & installation', 'System requirements', 'Database setup'],
      'Configuration Files': ['requirements.txt', '.env.example', 'Database config'],
      '.gitignore': ['__pycache__', '.env', '.venv', '*.db'],
      'Documentation': ['Database schema', 'User guide', 'Admin features'],
      'License': ['MIT o Apache 2.0'],
      'Tests': ['Database tests', 'User workflow tests'],
    },
  },
  {
    id: 4,
    ...
    requirements: {
      ...
      'Configuration Files': ['requirements.txt', '.env.example', 'Model configuration'],
      '.gitignore': ['__pycache__', 'models/', 'data/', '.env'],
      'Documentation': ['Algorithm details', 'Dataset requirements', 'Performance benchmarks'],
      'License': ['MIT o Apache 2.0'],
      'Tests': ['Model accuracy tests', 'Integration tests'],
      'CI/CD': ['Automated testing', 'Model deployment'],
    },
  },
];
